...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $admin = User::create(['first_name' => 'Admin', 'last_name' => 'System', 'username' => 'admin', 'email' => 'admin@ecommerce.e', 'email_verified_at' => now(), 'mobile' => '090123',  'status' => 1, 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10),]);
        $admin->attachRole($adminRole);  // بياخد صلاحية الادمن

        $supervisor = User::create(['first_name' => 'Supervisor', 'last_name' => 'System', 'username' => 'supervisor', 'email' => 'supervisor@ecommerce.e', 'email_verified_at' => now(), 'mobile' => '0901231', 'status' => 1, 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10)
        ]);
        $supervisor->attachRole($supervisorRole);

        $customer = User::create(['first_name' => 'Mahmoud', 'last_name' => 'Elmenofy', 'username' => 'mahmoud', 'email' => 'elmenofym8@gmail.com', 'email_verified_at' => now(), 'mobile' => '0901232', 'status' => 1, 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10),]);
...
//
//        for ( $i = 1; $i <=20; $i++){
//            $random_customer = User::create(['first_name' => $faker->firstName, 'last_name' => $faker->lastName, 'username' => $faker->userName, 'email' => $faker->unique()->safeEmail, 'email_verified_at' => now(), 'mobile' => '96650'. $faker->numberBetween('1000000', '9999999'), 'status' => 1, 'password' => bcrypt('123123123'), 'remember_token' => Str::random(10),]);
...
//        }
        ...
        ## PRODUCTS CATEGORY
        $manageProductCategory = Permission::create(['name' => 'manage_product_categories', 'display_name' => 'Categories', 'route' => 'product_categories', 'module' => 'product_categories', 'as' => 'product_categories.index', 'icon' => 'fas fa-file-archive', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '5',]);
        $manageProductCategory->parent_show = $manageProductCategory->id;
        $manageProductCategory->save();
        $showProductCategory = Permission::create(['name' => 'show_product_categories', 'display_name' => 'Categories', 'route' => 'product_categories', 'module' => 'product_categories', 'as' => 'product_categories.index', 'icon' => 'fas fa-file-archive', 'parent' => $manageProductCategory->id, 'parent_original' => $manageProductCategory->id, 'parent_show' => $manageProductCategory->id, 'sidebar_link' => '1', 'appear' => '1',]);
        $createProductCategory = Permission::create(['name' => 'create_product_categories', 'display_name' => 'Create Category', 'route' => 'product_categories', 'module' => 'product_categories', 'as' => 'product_categories.create', 'icon' => null, 'parent' => $manageProductCategory->id, 'parent_original' => $manageProductCategory->id, 'parent_show' => $manageProductCategory->id, 'sidebar_link' => '1', 'appear' => '0',]);
        $displayProductCategory = Permission::create(['name' => 'display_product_categories', 'display_name' => 'Show Category', 'route' => 'product_categories', 'module' => 'product_categories', 'as' => 'product_categories.show', 'icon' => null, 'parent' => $manageProductCategory->id, 'parent_original' => $manageProductCategory->id, 'parent_show' => $manageProductCategory->id, 'sidebar_link' => '1', 'appear' => '0',]);
        $updateProductCategory = Permission::create(['name' => 'update_product_categories', 'display_name' => 'Update Category', 'route' => 'product_categories', 'module' => 'product_categories', 'as' => 'product_categories.edit', 'icon' => null, 'parent' => $manageProductCategory->id, 'parent_original' => $manageProductCategory->id, 'parent_show' => $manageProductCategory->id, 'sidebar_link' => '1', 'appear' => '0',]);
        $deleteProductCategory = Permission::create(['name' => 'delete_product_categories', 'display_name' => 'Delete Category', 'route' => 'product_categories', 'module' => 'product_categories', 'as' => 'product_categories.destroy', 'icon' => null, 'parent' => $manageProductCategory->id, 'parent_original' => $manageProductCategory->id, 'parent_show' => $manageProductCategory->id, 'sidebar_link' => '1', 'appear' => '0',]);
        ...
        $createTags = Permission::create(['name' => 'create_tags', 'display_name' => 'Create Tags', 'route' => 'tags', 'module' => 'tags', 'as' => 'tags.create', 'icon' => null, 'parent' => $manageTags->id, 'parent_original' => $manageTags->id, 'parent_show' => $manageTags->id, 'sidebar_link' => '1', 'appear' => '0',]);
        $displayTags = Permission::create(['name' => 'display_tags', 'display_name' => 'Show Tags', 'route' => 'tags', 'module' => 'tags', 'as' => 'tags.show', 'icon' => null, 'parent' => $manageTags->id, 'parent_original' => $manageTags->id, 'parent_show' => $manageTags->id, 'sidebar_link' => '1', 'appear' => '0',]);
        $updateTags = Permission::create(['name' => 'update_tags', 'display_name' => 'Update Tags', 'route' => 'tags', 'module' => 'tags', 'as' => 'tags.edit', 'icon' => null, 'parent' => $manageTags->id, 'parent_original' => $manageTags->id, 'parent_show' => $manageTags->id, 'sidebar_link' => '1', 'appear' => '0',]);
        $deleteTags = Permission::create(['name' => 'delete_tags', 'display_name' => 'Delete Tags', 'route' => 'tags', 'module' => 'tags', 'as' => 'tags.destroy', 'icon' => null, 'parent' => $manageTags->id, 'parent_original' => $manageTags->id, 'parent_show' => $manageTags->id, 'sidebar_link' => '1', 'appear' => '0',]);
