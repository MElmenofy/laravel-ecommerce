<div class="row">
    <div class="col-lg-8">
        ...
        @if ($customer_address_id != 0 && $shipping_company_id)
        ...
        @if ($customer_address_id != 0 && $shipping_company_id && $payment_method_id != 0)
            @if(\Illuminate\Support\Str::lower($payment_method_code) == 'ppex')
                <form action="{{ route('checkout.payment') }}" method="post">
                    ...
                    <button type="submit" name="submit" class="btn btn-dark btn-sm btn-block">Continue to checkout with PayPal</button>
                </form>
            @endif
