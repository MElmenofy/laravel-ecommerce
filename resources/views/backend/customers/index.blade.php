                ...
                @forelse($customers as $customer)
                    <tr>
                        <td>
                            ...
                            @else
                                <img src="{{ asset('assets/users/avatar.svg') }}" width="60" height="60" alt="{{ $customer->full_name }}">
                            @endif
                        </td>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="javascript:void(0)" class="btn btn-danger"
                                   onclick="if (confirm('Are yuo sure to delete this record ?')){document.getElementById('delete-customer-{{ $customer->id }}').submit();} else {return false;}">
