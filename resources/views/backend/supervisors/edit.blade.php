...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">Edit Supervisors ({{ $supervisor->full_name }})</h6>
            <div class="ml-auto">
            ...
            $("#supervisor-image").fileinput({
                ...
                initialPreviewConfig: [
                        @if($supervisor->user_image != '')
                    {
                        ...
                        size: '1111',
                        width: "120px",
                        url: "{{ route('admin.supervisor.remove_image', ['supervisor_id' => $supervisor->id, '_token' => csrf_token()]) }}",
                        key: {{ $supervisor->id }}
                    }
                    @endif
                ]
