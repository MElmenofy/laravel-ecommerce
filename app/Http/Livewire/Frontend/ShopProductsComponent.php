...
class ShopProductsComponent extends Component
{
    ...
    public function addToCart($id)
    {
        ...
        if ($duplicates->isNotEmpty()){
            ...
            $this->emit('updateCart'); // في حالة نجاح الاضافه
    ...
    public function render()
    {
        ...
        if ($this->slug == ''){
            ...
            if (is_null($product_category->parent_id)){ // اذا كان فاضي
                $categoriesId = ProductCategory::whereParentId($product_category->id)->whereStatus(true)->pluck('id')->toArray();
